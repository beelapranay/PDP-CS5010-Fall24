  ...
  public void testLevelsAdjustWithSplit() {
    ...
    for (int y = 0; y < height; y++) {
      for (int x = 0; x < expectedSplitPoint; x++) {
        ...
        int expectedRed = applyQuadraticLevelsAdjustment(originalPixel.red, a, bCoef, c);
        int expectedGreen = applyQuadraticLevelsAdjustment(originalPixel.green, a, bCoef, c);
        int expectedBlue = applyQuadraticLevelsAdjustment(originalPixel.blue, a, bCoef, c);
